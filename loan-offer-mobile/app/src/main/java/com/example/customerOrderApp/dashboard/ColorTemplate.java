...
public class ColorTemplate {
    ...
    public static final int[] GREEN_COLORS = {
            Color.rgb(15, 89, 246  ), Color.rgb(179, 29, 186 ), Color.rgb(20, 142, 3  ),
            Color.rgb(193, 6, 20 ), Color.rgb(246, 15, 236)
    };
    public static final int[] BLUE_COLORS = {
            Color.rgb(8, 164, 169), Color.rgb(19, 196, 244  ), Color.rgb(66, 198, 233),
            Color.rgb(66, 127, 233  ), Color.rgb(7, 12, 169  )
    };
