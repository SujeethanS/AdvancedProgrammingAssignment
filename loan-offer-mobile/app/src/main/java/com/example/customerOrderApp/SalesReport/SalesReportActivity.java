...
public class SalesReportActivity extends AppCompatActivity implements  VolleyBackgroundTaskGet.ResultOrderDelegate ,
            TodaySalesReport.OnFragmentInteractionListener{
    ...
    private TodaySalesReport todayReport;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!CheckOnline.isOnline(SalesReportActivity.this)) {
            Intent startIntent = new Intent(SalesReportActivity.this, CheckInternetConnection.class);
        ...
        todayReport = new TodaySalesReport();

        viewPagerAdapter.addFragment(todayReport, "Sales");
