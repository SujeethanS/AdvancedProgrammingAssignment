package com.example.customerOrderApp.searchView;
...
/**
 * Created by keert on 05/06/2017.
 */
...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private void onVoiceClicked() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE_MODEL, RecognizerIntent.LANGUAGE_MODEL_WEB_SEARCH);    // setting recognition model, optimized for short phrases – ic_action_action_search queries
    ...
    /**
     * Calling this will set the query to ic_action_action_search text box. if submit is true, it'll submit the query.
     *
     * @param query
     * @param submit
     */
    ...
    /**
     * if show is true, this will enable voice ic_action_action_search. If voice is not available on the device, this method call has not effect.
     *
     * @param show
     */
    ...
    /**
     * Return true if ic_action_action_search is open
     *
     * @return
     */
    ...
    private void setVisibleWithAnimation() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            //       AnimationUtil.reveal(mSearchTopBar, (com.kalesystems.kaleinventory.utils.AnimationUtil.AnimationListener) animationListener);

        } else {
            //  AnimationUtil.fadeInView(mSearchLayout, mAnimationDuration, (com.kalesystems.kaleinventory.utils.AnimationUtil.AnimationListener) animationListener);
        }
    }

    /**
     * Close ic_action_action_search view.
     */
