...
class AnimationUtil {
    ...
    private static void fadeInView(View view, int duration, final AnimationUtil.AnimationListener listener) {
    ...
    private static void fadeOutView(View view, int duration, final AnimationUtil.AnimationListener listener) {
